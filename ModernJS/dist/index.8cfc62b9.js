...
_shoppingCartJs.addToCart("Apples", 5);
_shoppingCartJs.addToCart("Apples", 2);
console.log(_shoppingCartJs.tp, _shoppingCartJs.price);
...
parcelHelpers.export(exports, "tp", ()=>totalPrice) // function (item, quantity) {
 //   console.log(`${quantity} ${item} added to the cart.`);
 // }
;
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequirec887")
